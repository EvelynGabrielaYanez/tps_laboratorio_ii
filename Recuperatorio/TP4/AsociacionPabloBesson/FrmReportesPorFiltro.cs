...
namespace AsociacionPabloBesson
{
    public partial class FrmReportesPorFiltro : Form
    {
        ...
        private void CargarMotivosDeIngreso()
        {
            ...
            {
                chblstMotivosDeIngreso.Items.Add(causa.ObtenerDescripcion());
            }

            //foreach (ListItem item in chblstMotivosDeIngreso.Items)
            //{
            //    if (item.Text == "Questions and Answers")
            //    {
            //        item.Text = "Q&A";
            //    }
            //}
        ...
        private void btnFiltrar_Click(object sender, EventArgs e)
        {
            ...
            int? cantidadDenunciasDesde = null;
            int? cantidadDenunciasHasta = null;
            ...
            {
                cantidadDenunciasDesde = (int)nudDenunciasDesde.Value;
                cantidadDenunciasHasta = (int)nudDenunciasHasta.Value;
            }

            dataDeLaTabla = UsuarioControlador.Filtrar(fechaDesde: fechaDesde,fechaHasta: fechaHasta, cantidadDenunciasDesde: cantidadDenunciasDesde, cantidadDenunciasHasta: cantidadDenunciasHasta);
        ...
        private List<ETipoCausaIngreso> ObtenerMotivosDeIngresoSeleccionados()
        {
            ...
            {
                ETipoCausaIngreso tipoCausaIngreso = chblstMotivosDeIngreso.CheckedItems[i].ToString().ObtenerEnumeradoPorDescripcion<ETipoCausaIngreso>();

                listadoRetorno.Add(tipoCausaIngreso);
            }
